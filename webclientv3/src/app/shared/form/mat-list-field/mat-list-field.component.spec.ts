...
import { MatListFieldComponent } from "./mat-list-field.component";

describe("ListFieldComponent", () => {
  let component: MatListFieldComponent;
  let fixture: ComponentFixture<MatListFieldComponent>;
  let de: DebugElement;
  let sampleItems: any[];
  let selected: number;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [MatListFieldComponent]
    }).compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(MatListFieldComponent);
  ...
  describe("when editMode is true", () => {
    ...
    it("has a select element", () => {
      fixture.detectChanges();
      let select = de.query(By.css("mat-select"));
      expect(select).toBeTruthy();
    });

    xit("has x option elements for items of length x plus one blank element first", () => {
      fixture.detectChanges();
      let options = de.queryAll(By.css("mat-option"));
    ...
    describe("with grouping", () => {
      ...
      xit("has the correct number of option groups", () => {
        fixture.detectChanges(); /*? component.groups */
        let optGroups = de.queryAll(By.css("mat-optgroup"));
