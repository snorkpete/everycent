...
describe('EditActionsComponent', () => {
  ...
  describe('"Make Changes" button', () => {
    ...
    it('is hidden if editMode is true', () => {
      let makeChangesBtn = fixture.debugElement.nativeElement.querySelector('button.make-changes');
      expect(makeChangesBtn).toBeTruthy('button exists');

      component.editMode = true;
      fixture.detectChanges();

      makeChangesBtn = fixture.debugElement.nativeElement.querySelector('button.make-changes');
  ...
  describe('"Save" button', () => {
    ...
    it('does not exist by default', () => {
      let saveBtn = fixture.debugElement.nativeElement.querySelector('button.save');
  ...
  describe('"Cancel" button', () => {
    ...
    it('does not exist by default', () => {
      let cancelBtn = fixture.debugElement.nativeElement.querySelector('button.cancel');
    ...
    it('is visible if editMode is true', () => {
      ...
      cancelBtn = fixture.debugElement.nativeElement.querySelector('button.cancel');
