        ...
        <table class="table">
          <thead>
            <tr>
              ...
              <th>
                Balance At:
                <em>{{ firstBankAccount?.closing_date | date: "MMM dd" }}</em>
              </th>
              <th>
                Balance At:
                <em>{{
                  firstBankAccount?.next_closing_date | date: "MMM dd"
                }}</em>
              </th>
          ...
          <tbody>
            <tr *ngFor="let bankAccount of bankAccounts">
              ...
              <td class="right">
                {{ bankAccount?.closing_balance | ecMoney }}
              </td>
              <td class="right">
                {{ bankAccount?.expected_closing_balance | ecMoney }}
              </td>
              <td class="right">
                {{ bankAccount?.current_balance | ecMoney }}
              </td>
            </tr>
          </tbody>
          <tfoot>
